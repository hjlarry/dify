...
const ChatInputArea = ({ readonly, botName, chatInputPlaceholder, showFeatureBar, showFileUpload, featureBarDisabled, onFeatureBarClick, visionConfig, speechToTextConfig = { enabled: true }, onSend, inputs = {}, inputsForm = [], theme, isResponding, disabled, sendOnEnter = true }: ChatInputAreaProps) => {
  ...
  const placeholder = readonly
    ? t('chat.inputDisabledPlaceholder', { ns: 'common' })
    : chatInputPlaceholder?.trim()
      ? chatInputPlaceholder
      : t('chat.inputPlaceholder', { ns: 'common', botName })
